...
export class Reply extends React.Component{
    ...
    setContentOfReplyForm(content){
        this.commentForm.setState({
            content,
        });
    }
        ...
        return <div>
            ...
            {this.props.rows.map((c,i)=>{
                ...
                return <ReplyItem key={i} 
                    ...
                    onWantToReplyTo={(toReplyId,toUserId)=>{
                        ...
                        this.setContentOfReplyForm(`回复@${author.name}: `);
                    }}
                    onUpvote={(id)=>{
            ...
            <CommentForm 
                ...
                onSubmit={arg=>{
                    ...
                    const {scope,topicId,replyUnder}=this.props;
