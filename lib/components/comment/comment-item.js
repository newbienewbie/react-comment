    ...
    render() {
        return (<div className='comment-item'>
            ...
            <div className="comment-reply">
                {/* page ? */ }
                <Reply scope={this.props.scope} topicId={this.props.topicId} replyUnder={this.props.id} replyTo={this.props.id}
                    author={this.props.author}  
                    rows={this.props.replies.rows} count={this.props.replies.count} 
                    size={this.props.replyPageSize}
                    onReply={(scope,topicId,replyTo,content)=>{this.props.onReply(scope,topicId,replyTo,content)}}
