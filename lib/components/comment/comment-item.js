    ...
    render() {
        return (<div className='comment-item'>
            ...
            <div className="comment-body">
                <span><a href={'#'}>{this.props.author.username}</a></span>
            ...
            <div>
                <div>{this.props.upvotes}人赞同 
                    <button disabled={shouldDisable(this.props.currentUserOpinion)} onClick={(e)=>{
                        ...
                        赞<Icon.Like fill={hightlightColor(this.props.currentUserOpinion,'upvote')} />
                    </button>
                </div>
                <div>{this.props.downvotes}人反对 
                    <button disabled={shouldDisable(this.props.currentUserOpinion)}  onClick={e=>{
                        ...
                        踩<Icon.Dislike fill={hightlightColor(this.props.currentUserOpinion,'downvote')}  />
                    </button>
                </div>
