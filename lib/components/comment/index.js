...
export class Comment extends React.Component{
    ...
    componentDidMount(){
        const {scope,topicId,replyTo,currentCommentPage,commentPageSize,replyPageSize}=this.props;
        const action=fetchCommentList(scope,topicId,replyTo,currentCommentPage,commentPageSize);
        this.props.dispatch(action);
        const fetchReplyListAction=fetchReplyList(scope,topicId,currentCommentPage,commentPageSize,replyPageSize);
        this.props.dispatch(fetchReplyListAction);
    }
