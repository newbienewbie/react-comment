...
export function fetchWhenInitialLoading(scope,topicId,replyTo,commentPageSize,replyPageSize){
    ...
    const p1 = fetchCommentOrReplyList(scope, topicId, replyTo, 1, commentPageSize);
    const p2 = fetchFirstPageReplyList(scope, topicId, 1,commentPageSize, replyPageSize);
 ...
 */
export function fetchCommentOrReplyList(scope,topicId,replyTo,page=1,size=8){
...
export function fetchFirstPageReplyList(scope,topicId,page=1,size=10,replyPageSize=10){
    return fetch("/comment/list/all-reply-list-of-first-page",{
        method:'post',
        credentials:'same-origin',
        headers:{
            "Content-Type":"application/json",
...
export default {
    fetchCommentOrReplyList,
    fetchFirstPageReplyList,
    create,
    upvote,
    downvote
};